...
func (*Delete) Descriptor() ([]byte, []int) {
	return fileDescriptor_0d97e6830d5cc386, []int{0}
}
...
func init() {
	proto.RegisterType((*Delete)(nil), "rps.types.request.v1.Delete")
}

func init() { proto.RegisterFile("rps/types/request/v1/delete.proto", fileDescriptor_0d97e6830d5cc386) }

var fileDescriptor_0d97e6830d5cc386 = []byte{
	// 261 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0x2c, 0x2a, 0x28, 0xd6,
	0x2f, 0xa9, 0x2c, 0x48, 0x2d, 0xd6, 0x2f, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0xd1, 0x2f, 0x33,
	0xd4, 0x4f, 0x49, 0xcd, 0x49, 0x2d, 0x49, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x29,
	0x2a, 0x28, 0xd6, 0x03, 0x2b, 0xd1, 0x83, 0x2a, 0xd1, 0x2b, 0x33, 0x54, 0x92, 0xe1, 0x62, 0x73,
	0x01, 0xab, 0x12, 0x12, 0xe2, 0x62, 0x29, 0xce, 0x4f, 0x2b, 0x91, 0x60, 0x54, 0x60, 0xd4, 0xe0,
	0x08, 0x02, 0xb3, 0x9d, 0x1e, 0x33, 0x5e, 0x78, 0x28, 0xc7, 0x70, 0xe3, 0xa1, 0x1c, 0xc3, 0x87,
	...
	,
}
...
func (this *Delete) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&requestv1.Delete{")
	s = append(s, "Soft: "+fmt.Sprintf("%#v", this.Soft)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func valueToGoStringDelete(v interface{}, typ string) string {
...
func valueToStringDelete(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
